...
public:
    int uniquePathsWithObstacles(vector<vector<int> >& obstacleGrid) {
        ...
        for(size_t i = 1; i < m; i++)
        {
            ...
            {
                steps[i][j] =  ((obstacleGrid[i][j]) ? 0 : ( steps[i-1][j] + steps[i][j-1])) ;
            }
        }
...
/*
    ...
    */
    ...
    cout << sssss.uniquePathsWithObstacles(ss) << endl;
